...
const Contact: React.FC = () => {
  ...
  const notifySentForm: React.FormEventHandler<HTMLFormElement> = async (e) => {
    ...
    try {
      ...
      if (language === "HIN") {
        toast.success(toastMessages.successEmailSent.HIN);
      } else {
      ...
      console.log(error);
      if (language === "HIN") {
        toast.error(toastMessages.failedEmailSent.HIN);
      } else {
        ...
        >
          ...
          >
            <p className="text-[--black] mb-6">
              ...
              {language === "HIN" ? contactData.title.HIN : contactData.title.en}
              <span className="text-[--orange]">/&gt;</span>
            </p>

            <h2 className="text-[--black] text-center">
              {language === "HIN"
                ? contactData.description.HIN
        ...
        <div className="flex flex-row justify-center items-start px-32 pt-32 mb-32 max-lg:flex-col max-lg:p-10">
          ...
          >
            ...
            <textarea
              ...
              placeholder={
                language === "HIN"
                  ? `${contactData.textarea.placeholder.HIN}`
            ...
            <div className="privacy-checkbox flex gap-16">
              ...
              <p>
                {language === "HIN"
                  ? `${contactData.privacyOptIn.checkbox.HIN}`
                  : `${contactData.privacyOptIn.checkbox.en}`}
              </p>
            </div>
            <p>
              {language === "HIN"
                ? `${contactData.privacyOptIn.description.HIN}`
                : `${contactData.privacyOptIn.description.en}`}
            </p>
            <Button
              value={
                language === "HIN"
                  ? `${contactData.button.value.HIN}`
